...
public class DSignUp extends AppCompatActivity implements View.OnClickListener {


    EditText fname, lname, semail, pass, cpass, sdob, cno;
    Button bsignup;

    public static final String REGISTER_URL = "http://dmehta22.comli.com/DRegister.php";
    public static final String COUNT_URL = "http://dmehta22.comli.com/get_count_doc.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fname = (EditText) findViewById(R.id.dsignup_fn);
        lname = (EditText) findViewById(R.id.dsignup_ln);
        semail = (EditText) findViewById(R.id.dsignup_email);
        pass = (EditText) findViewById(R.id.dsignup_password);
        cpass = (EditText) findViewById(R.id.dsignup_confirm_password);
        sdob = (EditText) findViewById(R.id.dsignup_dob);
        cno = (EditText) findViewById(R.id.dsignup_contactno);

        bsignup = (Button) findViewById(R.id.dsignup_btn);
    ...
    public void onBackPressed() {
        Intent i5 = new Intent(DSignUp.this,Login.class);
        startActivity(i5);
    }
    ...
    private void verify() {
        AlertDialog alertDialog = new AlertDialog.Builder(DSignUp.this).create();
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            String msg = "" + COUNT;
                            Toast.makeText(DSignUp.this, msg, Toast.LENGTH_SHORT).show();
    ...
    private void insert_data() {
        ...
        final AlertDialog alertDialog = new AlertDialog.Builder(DSignUp.this).create();
        ...
        JsonObjectRequest req = new JsonObjectRequest(REGISTER_URL, insert,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                VolleyLog.e("Error: ", error.getMessage());
                error.printStackTrace();
                Toast.makeText(DSignUp.this, "Some Connection error maybe", Toast.LENGTH_SHORT).show();
